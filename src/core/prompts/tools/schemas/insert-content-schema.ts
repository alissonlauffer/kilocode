...
export function generateInsertContentSchema(args: ToolArgs): BaseToolSchema {
		...
		parameters: [
			{
				name: "path",
				type: "string",
				description: `File path relative to workspace directory ${args.cwd.toPosix()}`,
				required: true,
			},
			{
				name: "line",

...
export function generateBrowserActionSchema(args: ToolArgs): BaseToolSchema | undefined {
		...
		parameters: [
			{
				...
				type: "string",
				description:
					"The action to perform. The available actions are: launch, hover, click, type, resize, scroll_down, scroll_up, close",
				required: true,
			...
			},
			{
				name: "coordinate",
				type: "string",
				description: `The X and Y coordinates for the \`click\` and \`hover\` actions. Coordinates should be within the **${args.browserViewportSize}** resolution.`,
				required: false,
			},
			{
				name: "size",
